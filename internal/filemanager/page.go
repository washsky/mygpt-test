...
.notice{min-height:24px;color:var(--muted);margin-top:12px}.list{display:grid;gap:8px}.item{display:grid;grid-template-columns:minmax(0,1fr) auto auto auto;gap:12px;align-items:center;padding:12px;border:1px solid var(--line);border-radius:12px}
...
<label>关联类型<select name="related_type"><option value="">暂不关联</option><option value="post">帖子</option><option value="reply">回复</option></select></label>
